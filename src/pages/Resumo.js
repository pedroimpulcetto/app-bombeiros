...
import { StyleSheet, Image, View, Text, SafeAreaView, TouchableOpacity, Platform, StatusBar } from 'react-native';
			...
			if (talao.data_talao == hoje) {
				return (
					<View style={styles.talao}>
						<Text>
							<Text style={{ fontSize: 22, fontWeight: 'bold' }}>Horario:</Text>{' '}
	...
	return (
		<View style={styles.container}>
			...
			<View style={styles.card}>
				...
				{renderTalao()}
				<TouchableOpacity style={styles.button} onPress={() => navigation.navigate('Talao')}>
			...
			<View style={styles.card}>
				...
				<View style={styles.cardCrm}>{renderCrm()}</View>
				<TouchableOpacity style={styles.button} onPress={() => navigation.navigate('Crm')}>
