        ...
        <View style={styles.cardEdit}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Crm')}>
            <Image
              ...
              style={{resizeMode: 'contain', width: 50, height: 30, alignItems: 'flex-end' }}
            />
          </TouchableOpacity>
        </View>
      </>
  ...
  const ComponentLeft = () => {
    return(
      <View style={{ flex: 1, alignItems: 'flex-start'}} >
        <TouchableOpacity style={{justifyContent:'center', flexDirection: 'row'}} onPress={() => navigation.navigate('Crm')}>
